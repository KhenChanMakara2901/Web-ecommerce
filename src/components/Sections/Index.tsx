...
import IphoneMap from "@/src/Assets/Sections/IphoneMap.png";

export default function Index() {
  return (
    <section className="bg-white dark:bg-dark text-gray-900 dark:text-white">
      <div className="mx-auto w-full max-w-7xl px-5 py-16  md:py-20">
        <div className="grid gap-16 md:grid-cols-2 md:gap-4 lg:grid-cols-[1fr_340px_1fr]">
          ...
          <div className="w-86 mt-4 h-88 bg-contain bg-[50%_100%] bg-no-repeat [grid-area:3/1/4/3] sm:mt-12 sm:h-[560px] sm:w-full md:mt-0 lg:[grid-area:1/2/1/3]">
            <Image
              src={IphoneMap}
              alt="Iphone-Map"
              width={500}
